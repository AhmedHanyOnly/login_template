                      ...
                      <div class="vertical-center-inner">
                        ...
                        <div class="content-area">
                          ...
                          <div class="logon-area">
                                  ...
                                  <circle
                                    ...
                                    style="
                                      ...
                                      transition: stroke-dashoffset 0.7s
                                        cubic-bezier(0.4, 2.3, 0.3, 1);
                                    "
                                  />
                                  <polyline
                                    id="success-check"
                                    points="24,43 36,55 56,31"
                                    fill="none"
                                    stroke="#34c759"
                                    stroke-width="6"
                                    ...
                                    style="
                                      ...
                                      transition: stroke-dashoffset 0.4s 0.7s
                                        cubic-bezier(0.4, 2.3, 0.3, 1);
                                    "
                                  />
                                </svg>
                            ...
                            <script>
                              // Example: Show the checkmark after successful operation
                              // You should call this after your success event
