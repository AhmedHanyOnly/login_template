                ...
                <div class="p-size">
                    ...
                    <div class="p-size-in pt-3 text-start">
                        <label
                            class="mb-3"
                            id="lblReg"
                            aria-label="אם אין לך את הקוד הקבוע כי לא נרשמת עדיין או שכחת אותו ,">
                            אם אין לך את הקוד הקבוע כי לא נרשמת עדיין או שכחת אותו ,
                            <a
                                class="withColor"
                                href="../../SrRishum"
                                target="_blank"
                                aria-label="הקישור הזה יסייע לך&gt; ">
                                הקישור הזה יסייע לך&gt;
                            </a>
                            <br /><br />
                            <a
                                href="https://youtu.be/Rdn_Ramup98"
                                target="_blank"
                                class="withColor"
                                aria-label="צפו בסרטון שמסביר כיצד לבצע רישום">
                                צפו בסרטון שמסביר כיצד לבצע רישום
                            </a>
                        </label>
                        ...
                        <label
                            ...
                            class="mb-1"
                            role="alert"
                            style="display: none">ברגע זה שלחנו לך קוד אימות חד פעמי, יש להקלידו כעת</label>
                        ...
                        <div class="d-none">
                            ...
                            <p
                                id="recolor-actions"
                                style="display: none"
                                class="theme-highlight-sprite theme-highlight-color"></p>
                            <div
                                id="bundle-actions"
                                style="display: none"
                                class="bundleDetail"></div>
                            ...
                            <section
                                ...
                                <header class="about-header theme-header-bgcolor">
                                    ...
                                    <span
                                        class="header-title theme-header-color phone-only _ctxstxt_About">About</span>
                                </header>
                                <div class="aboutPhoneContent scrollable">
                                    ...
                                    <div class="copyrightContainer">
                                        ...
                                        <a
                                            ...
                                            target="_blank">Citrix Receiver for Web</a>
                                        <a
                                            ...
                                            target="_blank">Citrix Receiver for HTML5</a>
                                        <span class="citrixCopyright _ctxstxt_CitrixCopyright">© 2016 Citrix Systems, Inc.</span><br />
                                        <span class="_ctxstxt_AllRightsReserved">All rights reserved.</span><br />
                                        <a
                                            href="http://www.citrix.com"
                                            class="citrixLink"
                                            target="_blank">www.citrix.com</a>
                                    </div>
                                </div>
                            </section>
                            ...
                            <section
                                ...
                                <nav class="phone-only side-menu theme-header-bgcolor">
                                    ...
                                    <a
                                        ...
                                        <span class="action-text _ctxstxt_QuickAccess">Favorites</span>
                                    </a>
                                    <a
                                        id="desktopsBtnPhone"
                                        ...
                                        <span class="action-text _ctxstxt_Desktops">Desktops</span>
                                    </a>
                                    <a
                                        id="allAppsBtnPhone"
                                    ...
                                    <a
                                        ...
                                        <span class="action-text _ctxstxt_Preferences">Preferences</span>
                                    </a>
                                    <a
                                        href="#"
                                    ...
                                    <a
                                        ...
                                        <span class="action-text _ctxstxt_Refresh">Refresh</span>
                                    </a>
                                    <p class="user-display-name theme-header-color"></p>
                                    <a
                                        href="#"
                                        class="logoff-button theme-header-color _ctxstxt_LogOff">Log Off</a>
                                </nav>
                                ...
                                <div class="home-view-content">
                                    ...
                                    <header class="store-header theme-header-bgcolor">
                                        ...
                                        <div
                                            class="logo-container hdpi-capable tablet-only"></div>
                                        <span
                                            class="header-title theme-header-color phone-only"></span>
                                        ...
                                        <section
                                            ...
                                            <a
                                                ...
                                                <span
                                                    class="_ctxstxt_QuickAccess theme-header-color">Favorites</span>
                                            </a><a
                                                id="desktopsBtn"
                                                class="toggle-view-button desktops-view">
                                                <div class="view-sprite"></div>
                                                <span class="_ctxstxt_Desktops theme-header-color">Desktops</span>
                                            </a><a
                                                id="allAppsBtn"
                                                class="toggle-view-button store-view">
                                                <div class="view-sprite"></div>
                                                <span class="_ctxstxt_AllApps theme-header-color">Apps</span>
                                            </a><a
                                                id="tasksBtn"
                                                class="toggle-view-button tasks-view">
                                                <div class="view-sprite"></div>
                                                <span class="_ctxstxt_Tasks theme-header-color">Tasks</span>
                                            </a>
                                        </section>
                                        <div class="headerRight tablet-only">
                                            ...
                                            <div
                                                ...
                                                <a
                                                    ...
                                                    <div
                                                        class="settings-button-arrow view-sprite"></div>
                                                </a>
                                    ...
                                    <nav
                                        ...
                                        <a
                                            ...
                                            href="#">
                                            <div
                                                class="backButton theme-highlight-sprite"></div>
                                        </a><a
                                    ...
                                    <section class="toolbar store-toolbar-phone phone-only">
                                        <div class="store-toolbar-phone-content">
                                            <a
                                                ...
                                                <span
                                                    class="_ctxstxt_AllAppsForToolbar theme-highlight-border-color">All</span>
                                            </a>
                                            <a
                                                ...
                                                <span
                                                    class="_ctxstxt_Categories theme-highlight-border-color">Categories</span>
                                            </a>
                                        </div>
                                    ...
                                    <section class="scrollable storeViewSection">
                                        ...
                                        <div class="applicationBundleContainer">
                                            <div class="content">
                                                ...
                                                <a class="prevBundleOuter hidden" href="#">
                                                    <div
                                                        class="prevBundle theme-highlight-color theme-highlight-sprite"></div>
                                                    <div
                                                        class="prevBundle hover theme-highlight-color theme-highlight-sprite"></div>
                                                </a>
                                                <a class="nextBundleOuter hidden" href="#">
                                                    <div
                                                        class="nextBundle theme-highlight-color theme-highlight-sprite"></div>
                                                    <div
                                                        class="nextBundle hover theme-highlight-color theme-highlight-sprite"></div>
                                                </a>
                                            </div>
                                        </div>
                                        ...
                                        <div class="no-results-message">
                                            ...
                                            <a
                                                href="#"
                                                class="all-app-results theme-highlight-color _ctxstxt_TrySearchingInApps">Try searching in Apps.</a>
                                        </div>
                                        <div class="no-fav-results-message">
                                            ...
                                            <div
                                                id="no-fav-msg-desc"
                                                class="_ctxstxt_AddFavoritesDescriptionTablet no-fav-results-message-description"></div>
                                            <div
                                    ...
                                    <section class="appInfoView scrollable">
                                        <div class="appInfoHeader">
                                            ...
                                            <div class="storeapp-loading-overlay">
                                                <div
                                                    class="spinner storeapp-loading-spinner"></div>
                                            </div>
                                        ...
                                        <div class="appInfoActions">
                                            ...
                                            <a
                                                id="appInfoOpenBtn"
                                                href="#"
                                                class="theme-highlight-color theme-highlight-border-color appInfoActionButton _ctxstxt_Open">Open</a><a
                                                id="appInfoRestartBtn"
                                                href="#"
                                                class="theme-highlight-color theme-highlight-border-color appInfoActionButton _ctxstxt_Restart">Restart</a><a
                                                id="appInfoRequestButton"
                                                href="#"
                                                class="theme-highlight-color theme-highlight-border-color appInfoActionButton _ctxstxt_Request">Request</a><a
                                                id="appInfoCancelRequestButton"
                                                href="#"
                                                class="theme-highlight-color theme-highlight-border-color appInfoActionButton _ctxstxt_CancelRequest">Cancel Request</a><a
                                                id="appInfoAddButton"
                                                href="#"
                                                class="theme-highlight-color theme-highlight-border-color appInfoActionButton">
                                                <div class="theme-highlight-sprite addIcon"></div>
                                                <span class="_ctxstxt_AddToFavorites">Add To Favorites</span>
                                                ...
                                                class="theme-highlight-color theme-highlight-border-color appInfoActionButton">
                                                <div
                                                    class="theme-highlight-sprite addedIcon"></div>
                                        ...
                                        <div class="appInfoMain">
                                            <div
                                                ...
                                                <a
                                                    href="#"
                                                    class="more desc-link descriptionText theme-highlight-color _ctxstxt_More">More</a>
                                            </div>
                                            <div class="full app-description descriptionText">
                                                <a
                                                    href="#"
                                                    class="less desc-link descriptionText theme-highlight-color _ctxstxt_Less">Less</a>
                                            </div>
                                            <div id="pluginInfo">
                            ...
                            <section
                                ...
                                <div class="vertical-center-outer">
                                    <div class="vertical-center-inner">
                                        <div
                                            class="logon-small logon-logo-container NS-AAA"></div>
                                        ...
                                        <div class="logoff-complete content-area">
                                            ...
                                            <div
                                                class="logoff-complete-content detail-text"></div>
                                            ...
                                            <p class="remember-logon-method detail-text">
                                                <input
                                                    ...
                                                    checked="checked" />
                                                <label
                                                    for="remember-logon-method-checkbox"></label>
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="content-area">
                                        <div id="pluginExplicitAuthTop" class="pluginAuthTop">
                                            <div
                                                ...
                                                class="customAuthTop"></div>
                                        </div>
                                        <div class="logon-area">
                                            <div
                                                class="logon-spacer logon-large logon-logo-container NS-AAA"></div>
                                            <div class="logon-spacer-DefaultTheme"></div>
                                            <div class="form-content">
                                                <div class="form-container">
                                                    <form
                                                        class="form insertPoint credentialform"
                                                        action="/nf/auth/doAuthentication.do"
                                                        method="POST">
                                                        <div
                                                            class="field CredentialTypeusernameusername">
                                                            <div class="left">
                                                                <div class="standaloneText label plain">
                                                        ...
                                                        <div class="field CredentialTypeusername">
                                                            <div class="left">
                                                                <label for="login" class="label plain">מספר זהות</label>
                                                            </div>
                                                            <div class="right">
                                                                <input
                                                                    name="login"
                                                        ...
                                                        <div class="field CredentialTypepassword">
                                                            <div class="left">
                                                                <label for="passwd" class="label plain">קוד משתמש קבוע</label>
                                                            </div>
                                                            <div class="right">
                                                                <input
                                                                    name="passwd"
                                                                ...
                                                                <label
                                                                    ...
                                                                    id="infoPass"
                                                                    class="info-txt">
                                                                    *קוד המשתמש שקיבלת בתהליך הרישום
                                                                </label>
                                                            </div>
                                                        </div>
                                                        <div class="field buttonsrow">
                                                            <div class="buttonscontainer right">
                                                                <a
                                                                    id="loginBtn"
                                                                    href="#"
                                                                    class="button forms-authentication-button last-child default btn btn-primary w-100 mt-5">המשך</a>
                                                            </div>
                                                            <div
                                                                class="spinner"
                                                        ...
                                                        <div class="field CredentialType">
                                                            <div class="left">
                                                                <div class="standaloneText label plain">
                                                                    <div class="textContent"></div>
                                                                </div>
                                                ...
                                                <p class="back-to-choices" style="display: none">
                                                    <a
                                                        href="#"
                                                        class="authentication-link _ctxstxt_UseAnotherLogonOption">Use another logon option</a>
                                                </p>
                                            </div>
                                        ...
                                        <div class="content-area">
                                            <div class="logon-area">
                                                ...
                                                <div
                                                    ...
                                                    <p
                                                        class="authentication-message detail-text"></p>
                                                    <div class="buttonscontainer">
                                                        <a
                                                            href="#"
                                                            id="btnPasswordChange"
                                                            class="default stacked button _ctxstxt_PasswordExpiryChange">Change Now</a>
                                                        <a
                                                            href="#"
                                                            id="btnPasswordContinue"
                                                            class="stacked button _ctxstxt_PasswordExpiryChangeLater">Not Now</a>
                                                    </div>
                                                </div>
                                                <div class="logon-spacer"></div>
                                            </div>
                                            ...
                                            <div class="actions">
                                                <p class="pluginassistant-details">
                                                    ...
                                                    <label
                                                        ...
                                                        <span class="detail-text _ctxstxt_IAgreeWith">I agree with the</span>
                                                        <a
                                                            class="licenseagreement-link web-screen-link _ctxstxt_CitrixLicenseAgreement"
                                                            href="#"
                                                            role="link">Citrix license agreement</a>
                                                    </label>
                                                </p>
                                                <p>
                                                    <a
                                                        href="#"
                                                        class="installbutton default button disabled action-with-long-tooltip _ctxstxt_Install">Install</a>
                                                </p>
                                            </div>
                                            <div class="footer">
                                                <a
                                                    ...
                                                    href="#"
                                                    role="link">Security details</a><span class="bar-separator">|</span><a
                                                    class="pluginassistant-skiplink web-screen-link _ctxstxt_SkipToLogon _ctxsattr_title_SkipToLogonTip"
                                                    href="#"
                                                    title="Click here to skip to log on">המשך</a>
                                            </div>
                                            <div
                                    ...
                                    <div class="vertical-center-inner">
                                        <div
                                            ...
                                            <div class="content">
                                                ...
                                                <a
                                                    href="#"
                                                    class="pluginassistant-skiplink default button _ctxstxt_Continue">המשך</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="vertical-center-inner">
                                        <div class="polling-plugin content-area">
                                            ...
                                            <div class="content">
                                                ...
                                                <p class="detail-text">
                                                    <span class="_ctxstxt_OnceComplete">After Citrix Receiver is installed, </span><span class="_ctxstxt_ClickContinue">click <strong>Continue</strong>.</span>
                                                </p>
                                            </div>
                                            <div class="actions">
                                                <a
                                                    href="#"
                                                    class="skip-polling-wait default button _ctxstxt_Continue">המשך</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="vertical-center-outer">
                                    <div class="vertical-center-inner">
                                        <div class="polling-plugin-ie content-area">
                                            ...
                                            <div class="content">
                                                <p
                                                    class="polling-plugin-installmessage detail-text _ctxstxt_ClickLogOnToContinue"></p>
                                            </div>
                                    ...
                                    <div class="vertical-center-inner">
                                        <div class="detect-container content-area">
                                            <div class="box-links detection-right-links">
                                                ...
                                                <p
                                                    class="detect-if-already-installed detail-text"></p>
                                                ...
                                                <div class="footer">
                                                    <a
                                                        ...
                                                        href="#">Detect again</a>
                                                    <span
                                                        class="detect-retry-detection-separator bar-separator">|</span>
                                                    <a
                                                        class="detect-use-light-version web-screen-link _ctxstxt_UseLightVersion"
                                                        href="#">Use light version</a>
                                                    <span
                                                        class="detect-use-light-version-separator bar-separator">|</span>
                                                    <a
                                                        class="detect-already-installed web-screen-link _ctxstxt_AlreadyInstalled"
                                                        href="#">Already installed</a>
                                                    <span
                                                        class="detect-already-installed-separator bar-separator">|</span>
                                                    <a
                                                        class="securitydetailslink web-screen-link _ctxstxt_SecurityDetails"
                                                        href="#"
                                                        role="link">Security details</a>
                                                </div>
                                                <div
                                                    class="acceptterms-popup pluginassistant-popup">
                                                    <div
                                    ...
                                    <div class="vertical-center-inner">
                                        <div class="download-container content-area">
                                            <div class="box-links detection-right-links">
                                                ...
                                                <p
                                                    class="download-install-receiver detail-text"></p>
                                                <a
                                                ...
                                                <div class="footer">
                                                    <a
                                                        ...
                                                        href="#">Retry download</a>
                                                    <span
                                                        class="download-retry-separator bar-separator">|</span>
                                                    <a
                                            ...
                                            <div class="box-links detection-right-links">
                                                ...
                                                <div class="footer">
                                                    ...
                                                    <a
                                                        ...
                                                        href="#">Download again</a>
                                                    <span
                                                        class="validate-retry-download-separator bar-separator">|</span>
                                                    <a
                                                        class="validate-use-light-version web-screen-link _ctxstxt_UseLightVersion"
                                                        href="#">Use light version</a>
                                                    <span
                                                        class="validate-use-light-version-separator bar-separator">|</span>
                                                    <a
                                    ...
                                    <div class="vertical-center-inner">
                                        <div class="changeclient-container content-area">
                                            <div class="box-links detection-right-links">
                                                ...
                                                <p
                                                    class="changeclient-currently-using detail-text"></p>
                                                <div class="footer">
                                                    <a
                        ...
                        <section id="forgotCode">
                            <div class="text-center">
                                <a class="withColor" href="../../SrRishum" target="_blank">שכחתי את הקוד הקבוע</a>
                            </div>
                            <div class="mt-5">
                                <p>
                                    <b>בכניסה עם כרטיס או TOKEN מגורם מאשר</b>&nbsp;, חשוב
                                    להכניסו להתקן הקורא, <b>ורק לאחר מכן</b> &nbsp;לפתוח
                                    דפדפן ולגלוש לשירות הנבחר
                                </p>
                            </div>
                        </section>
                    </div>
